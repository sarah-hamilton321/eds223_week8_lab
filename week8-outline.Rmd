...
```{r include=TRUE}
landsat_20180612 <-rast(here("data (1)", "landsat_20180612.tif"))
landsat_20180815 <- rast(here("data (1)", "landsat_20180815.tif"))
landsat_20181018 <- rast(here("data (1)", "landsat_20181018.tif"))
landsat_20181103 <- rast(here("data (1)", "landsat_20181103.tif"))
landsat_20190122 <- rast(here("data (1)", "landsat_20190122.tif"))
landsat_20190223 <- rast(here("data (1)", "landsat_20190223.tif"))
landsat_20190412 <- rast(here("data (1)", "landsat_20190412.tif"))
landsat_20190701 <- rast(here("data (1)", "landsat_20190701.tif"))
```
...
all_ndvi <- c(ndvi_20180612, ndvi_20180815, ndvi_20181018, ndvi_20181103, 
              ndvi_20190122, ndvi_20190223, ndvi_20190412, ndvi_20190701)
...
sites <- st_read(here("data (1)", "study_sites.shp"))
...
sites_annotated <- cbind(sites, sites_ndvi) #binds a whole column to a data frame
...
ggplot(sites_clean, aes(x = date, y = NDVI, group = study_site, col = study_site)) +
    geom_line()
